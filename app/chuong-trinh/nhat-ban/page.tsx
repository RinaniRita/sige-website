...
export const metadata = {
  title: "Du học Nhật Bản | SIGE",
  description: "Chương trình du học Nhật Bản sắp được cập nhật. Đăng ký để nhận thông tin sớm nhất.",
}
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-slate-300 max-w-2xl">
              Các chương trình du học Nhật Bản đang được chuẩn bị và sẽ sớm ra mắt
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-lg mx-auto text-center">
            ...
            <p className="text-slate-600 mb-10 leading-relaxed">
              SIGE đang hợp tác với các trường đại học uy tín tại Nhật Bản để mang đến các chương trình du học chất lượng cao. Đăng ký để nhận thông tin sớm nhất khi chương trình được công bố.
            </p>
